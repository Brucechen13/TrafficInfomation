...
public class MainActivity extends FragmentActivity implements OnTabChangeListener, FragmentCallback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("SDKQQAgentPref","login success:"+user.getNickName());
	...
	private void setupViews() {
        ...
        FragmentUtils.replaceFragment(fragmentManager, R.id.layout_content,FragmentMap.class, null, false);
